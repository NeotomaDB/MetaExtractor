...
flowchart TD
F8(Labelled JSON files<br>from LabelStudio) --> C2(Split into Train/Val/Test<br>Sets by xDD ID)
...
```{python}
# | label: extraction_recall_results
# | warning: false
# | echo: false
# | layout-ncol: 1
...
The token based recall for each model on the test set by entity type are shown below:
...
![Confusion Matrix for RoBERTa Model](../../results/ner/roberta-finetuned-v3/roberta-finetuned-v3_test_confusion_matrix.png)
