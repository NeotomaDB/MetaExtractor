...
thanks: A huge thanks to Simon Goring & Socorro Dominguez from the Neotoma Database team for their support on this project thus far.
date: today
author:   
  - Ty Andrews  
  - Jenit Jain
...
+------------------------+----------------------------------------+----------------------------------------------------------------+
| published              | Date article was published             | Year month as numeric features                                 |
+------------------------+----------------------------------------+----------------------------------------------------------------+
...
First model baselines will be developed then more advanced techniques will be evaluated.

### Success Criteria

Approaches will be evaluated primarily on F1-Score with recall being monitored to reduce false negatives.
...
Exisiting research [@inproceedings] [@unsupervised] has shown the following models to perform well on this type of text based classification problem:
...
The entities to be extracted and their general formats are:
...
A draft wireframe for how the tool may look is below.

![Data review tool wireframe.](assets/data-review-tool-wireframe.png)

# Timeline

Deadlines and proposed intermediate milestones are outlined below. Tasks will be completed in parallel by the team where appropriate.
